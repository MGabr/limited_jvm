const char *opcode_strings[255] = {
	"NOP", "", "ICONST_M1", "ICONST_0", "ICONST_2",
	...
	"", "", "", "", "",
	"", "", "", "ISTORE", "LSTORE",
	"FSTORE", "DSTORE", "", "ISTORE_0", "ISTORE_1", 
	...
	"L2I", "L2F", "L2D", "F2I", "F2L",
	"F2D", "D2I", "D2L", "D2F", "INT2BYTE",
	"INT2CHAR", "INT2SHORT", "LCMP", "FCMPL", "FCMPG",
